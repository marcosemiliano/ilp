...
{ # Divisor de fluxo de execução
  ...
  { # aqui faremos o controle da transação que faz a exclusão
    ...
    printf("$mens<br>\n");
    printf("<button type='button' onclick='history.go(-1)'>Voltar</button><button type='button' onclick='history.go(-2)'>Escolher outro</button><button type='button' onclick='history.go(-3)'>Sair</button>\n");
  }
}
finalpage();
?>
